package cc.dreamcode.report.boot;

import cc.dreamcode.report.ReportLogger;
...
public abstract class PluginBootLoader extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        ReportPlugin.getReportLogger().info(String.format("Active version: v%s - Author: %s",
    ...
    public void registerInjectable(@NonNull Object object) {
        ...
        ReportPlugin.getReportLogger().info(
                new ReportLogger.Loader()
