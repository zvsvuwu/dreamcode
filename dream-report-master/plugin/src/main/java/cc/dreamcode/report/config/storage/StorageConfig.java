package cc.dreamcode.report.config.storage;

import cc.dreamcode.report.storage.StorageType;
...
public class StorageConfig extends OkaeriConfig {
    ...
    public String prefix = "dreamreport";
    ...
    @Comment("H2     : jdbc:h2:file:./plugins/Dream-Report/storage;mode=mysql")
