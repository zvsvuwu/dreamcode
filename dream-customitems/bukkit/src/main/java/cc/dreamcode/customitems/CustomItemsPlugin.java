...
import cc.dreamcode.customitems.command.CustomItemsCommand;
import cc.dreamcode.customitems.controller.CustomItemController;
...
public final class CustomItemsPlugin extends DreamBukkitPlatform implements DreamBukkitConfig {

    @Getter private static CustomItemsPlugin customItemsPlugin;

    @Override
    public void load(@NonNull ComponentManager componentManager) {
        customItemsPlugin = this;
    }
    ...
    public void enable(@NonNull ComponentManager componentManager) {
        ...
        Arrays.asList(
                CustomItemsCommand.class,
                CustomItemController.class
    ...
    public @NonNull DreamVersion getDreamVersion() {
        return DreamVersion.create("Dream-CustomItems", "1.0", "Kajteh_");
    }
