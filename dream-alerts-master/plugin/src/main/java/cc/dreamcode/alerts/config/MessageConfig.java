...
@Headers({
        @Header("## Dream-Alerts (Message-Config) ##"),
...
public class MessageConfig extends OkaeriConfig {
    ...
    public Notice success = new Notice(Notice.Type.CHAT, "&aPomyslnie wyslano alert");
    public Notice reloaded = new Notice(Notice.Type.CHAT, "&aPomyslnie przeladowano config");
}
