...
import cc.dreamcode.cobblex.component.ComponentHandler;
import cc.dreamcode.cobblex.config.ConfigLoader;
import cc.dreamcode.cobblex.config.MessageConfig;
import cc.dreamcode.cobblex.config.PluginConfig;
import cc.dreamcode.cobblex.exception.PluginRuntimeException;
import cc.dreamcode.cobblex.features.hook.HookService;
import cc.dreamcode.cobblex.features.menu.MenuActionHandler;
import cc.dreamcode.cobblex.features.user.UserActionHandler;
import cc.dreamcode.cobblex.features.user.UserRepository;
import cc.dreamcode.cobblex.features.user.UserRepositoryFactory;
import cc.dreamcode.cobblex.nms.api.NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_10_R1.V1_10_R1_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_11_R1.V1_11_R1_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_12_R1.V1_12_R1_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_13_R2.V1_13_R2_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_14_R1.V1_14_R1_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_15_R1.V1_15_R1_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_16_R3.V1_16_R3_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_17_R1.V1_17_R1_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_18_R2.V1_18_R2_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_19_R1.V1_19_R1_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_8_R3.V1_8_R3_NmsAccessor;
import cc.dreamcode.cobblex.nms.v1_9_R2.V1_9_R2_NmsAccessor;
import cc.dreamcode.cobblex.persistence.PersistenceHandler;
import cc.dreamcode.cobblex.persistence.PersistenceService;
...
@Plugin(name = "Dream-Cobblex", version = "1.0-SNAPSHOT")
@Author("Ravis96")
@Description("Cobblex plugin for DreamCode.")
