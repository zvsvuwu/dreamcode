...
import cc.dreamcode.chatmanager.ChatManagerLogger;
...
public abstract class PluginBootLoader extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        ChatManagerPlugin.getChatManagerLogger().info(String.format("Active version: v%s - Author: %s",
    ...
    public void registerInjectable(@NonNull Object object) {
        ...
        ChatManagerPlugin.getChatManagerLogger().info(
                new ChatManagerLogger.Loader()
