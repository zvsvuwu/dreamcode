package cc.dreamcode.chatmanager.component.classes;
...
import cc.dreamcode.chatmanager.config.ConfigSerdesPack;
...
public class ConfigurationComponentClassResolver extends ComponentClassResolver<Class<OkaeriConfig>> {
    ...
    private @Inject ChatManagerPlugin chatmanagerPlugin;
    ...
    public Object resolve(@NonNull Injector injector, @NonNull Class<OkaeriConfig> okaeriConfigClass) {
        ...
        return ConfigManager.create(okaeriConfigClass, (it) -> {
            ...
            it.withBindFile(new File(this.chatmanagerPlugin.getDataFolder(), configuration.child()));
            it.saveDefaults();
            it.load(true);
        });
    }
