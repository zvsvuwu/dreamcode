...
import cc.dreamcode.leaderboard.command.annotations.RequiredPermission;
...
import cc.dreamcode.leaderboard.exception.PluginValidatorException;
...
public abstract class CommandHandler extends Command implements PluginIdentifiableCommand, NoticeSender, CommandPlatform {
    ...
    public Plugin getPlugin() {
        return LeaderboardPlugin.getLeaderboardPlugin();
    }

    @Override
    public boolean execute(@NonNull CommandSender sender, @NonNull String commandLabel, @NonNull String[] arguments) {
        final MessageConfig messageConfig = LeaderboardPlugin.getLeaderboardPlugin().getInject(MessageConfig.class)
    ...
    public @NonNull List<String> tabComplete(@NonNull CommandSender sender, @NonNull String label, @NonNull String[] args) {
        ...
        this.argumentHandlers
                .stream()
                .map(argumentClass -> LeaderboardPlugin.getLeaderboardPlugin().createInstance(argumentClass))
