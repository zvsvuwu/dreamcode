package cc.dreamcode.leaderboard.boot;
...
public final class PluginFactory {
    ...
    public static boolean checkPlugin(final AtomicBoolean atomicBoolean, final PluginDescriptionFile pluginDescriptionFile) {
        if (!pluginDescriptionFile.getRawName().equals("Dream-Leaderboard")) {
        ...
        if (pluginDescriptionFile.getDescription() != null &&
                !pluginDescriptionFile.getDescription().equals("Leaderboard plugin by DreamCode.")) {
            atomicBoolean.set(true);
