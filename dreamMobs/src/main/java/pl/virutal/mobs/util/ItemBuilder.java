...
public class ItemBuilder {
    ...
    public ItemBuilder(XMaterial m, int amount){
        is= new ItemStack(m.parseMaterial(), amount);
    }
     ...
     */
    public ItemBuilder(XMaterial m, int amount, byte durability){
        is = new ItemStack(m.parseMaterial(), amount, durability);
    }
    /**
    ...
    public XMaterial getType(){
        return XMaterial.matchXMaterial(is.getType());
    }
    ...
    public List<String> getLore(){ return is.getItemMeta().getLore(); }
}
