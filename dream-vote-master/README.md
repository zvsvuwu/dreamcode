Working with vote:
-----
Clone this repo to your account, rename package name, then by pressing ``CTRL + SHIFT + R`` change all variables to your plugin name. (Vote --> PluginName).

Finally, remove all **unnecessary** vote functions.
