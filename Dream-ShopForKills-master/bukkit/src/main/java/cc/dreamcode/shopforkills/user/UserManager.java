...
import cc.dreamcode.shopforkills.ShopPlugin;
...
public class UserManager {
    ...
    private @Inject ShopPlugin shopPlugin;
    ...
    public void sync(Consumer<Exception> exceptionConsumer) {
        ...
        this.tasker.newChain()
                ...
                .acceptAsync(users -> {
                    this.users.clear();
                    users.forEach(user -> this.users.put(user.getUniqueId(), user));
    ...
    public void createUser(Player player) {
        ...
        this.tasker.newSharedChain("dbops:" + player.getUniqueId().toString())
                .async(() -> this.userRepository.findOrCreateByPath(player.getUniqueId()))
                .acceptAsync(user -> {
                    user.save();
                })
                ...
                .acceptAsync(user -> {
                    ...
                    if (this.pluginConfig.debug) {
                        this.dreamLogger.debug(new DreamLogger.Builder()
                                ...
                                .name(user.getUniqueId().toString())
