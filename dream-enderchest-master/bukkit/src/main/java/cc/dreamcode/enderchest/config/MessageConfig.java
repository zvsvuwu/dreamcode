...
@Headers({
        @Header("## Dream-Enderchest (Message-Config) ##"),
...
public class MessageConfig extends OkaeriConfig {
    ...
    public BukkitNotice enderchestPermission = new BukkitNotice(MinecraftNoticeType.CHAT, "&cNie posiadasz uprawnien do tego enderchesta!");
