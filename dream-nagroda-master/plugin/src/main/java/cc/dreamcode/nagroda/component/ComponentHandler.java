package cc.dreamcode.nagroda.component;

import cc.dreamcode.nagroda.builder.ListBuilder;
import cc.dreamcode.nagroda.component.classes.CommandComponentClassResolver;
import cc.dreamcode.nagroda.component.classes.ConfigurationComponentClassResolver;
import cc.dreamcode.nagroda.component.classes.DocumentPersistenceComponentClassResolver;
import cc.dreamcode.nagroda.component.classes.DocumentRepositoryComponentClassResolver;
import cc.dreamcode.nagroda.component.classes.JdaListenerComponentClassResolver;
import cc.dreamcode.nagroda.component.classes.ListenerComponentClassResolver;
import cc.dreamcode.nagroda.component.classes.ObjectComponentClassResolver;
import cc.dreamcode.nagroda.component.classes.RunnableComponentClassResolver;
...
public final class ComponentHandler {
    ...
    private final List<Class<? extends ComponentClassResolver>> classResolvers = new ListBuilder<Class<? extends ComponentClassResolver>>()
            ...
            .add(JdaListenerComponentClassResolver.class)
