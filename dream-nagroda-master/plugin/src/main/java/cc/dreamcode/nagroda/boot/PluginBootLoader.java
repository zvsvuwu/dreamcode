package cc.dreamcode.nagroda.boot;
...
public abstract class PluginBootLoader extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        NagrodaPlugin.getNagrodaLogger().info(String.format("Active version: v%s - Author: %s",
    ...
    public abstract void start(@NonNull ComponentHandler componentHandler) throws InterruptedException;
    ...
    public void registerInjectable(@NonNull Object object) {
        ...
        NagrodaPlugin.getNagrodaLogger().info(
                new NagrodaLogger.Loader()
