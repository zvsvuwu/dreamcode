package cc.dreamcode.nagroda.config.storage;

import cc.dreamcode.nagroda.storage.StorageType;
...
public class StorageConfig extends OkaeriConfig {
    ...
    public String prefix = "dreamnagroda";
    ...
    @Comment("H2     : jdbc:h2:file:./plugins/Dream-Nagroda/storage;mode=mysql")
    public String uri = "";
